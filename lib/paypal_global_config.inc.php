 ...
 *
 * ANDROMED MODS Feb 13, 2006
 * -> Replaced all $array_name[constant] with ['constant']
 *    throughout program
 * -> showVariables() was completely replaced with recursive
 *    dump of the $paypal array, no explicit variables.
 */
